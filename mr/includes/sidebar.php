            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <!-- <li>
                            <a href="doctor-list.php">Pending DCR</a>
                        </li>

                        <li>
                            <a href="clinic-input.php">Submitted DCR</a>
                        </li> -->
                ...
                <li>
                    <a href="target.php" class="waves-effect">
                        <i class="ri-money-dollar-circle-line"></i>
                        <span>Target</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="tour-plan-add.php">Tour Plan Add</a>
                        </li>
                        ...
                        <!-- <li>
                            <a href="tour-day-plan-list.php">Tour Day Plan List</a>
                        </li> -->
                ...
                "));
                                ...
                                if ($unread > 0) {
                                    echo '<span class="badge bg-danger float-end">' . $unread . '</span>';
                                }
                ...
                <!-- <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="dcr-list.php">DCR Report</a>
                        </li>
                        ...
                        <li>
                            <a href="expense-list.php">Expense Report</a>
                        </li>

                        <li>
                            <a href="target-report.php">Target Report</a>
                        </li>
