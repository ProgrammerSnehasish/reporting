...
INNER JOIN tbl_user_mapping um2
    ON um2.employee_user_id = um.manager_user_id
...
LEFT JOIN tbl_users au
    ON au.id=tp.approved_by

LEFT JOIN tbl_employees ae
    ON ae.id=au.employee_id

WHERE
tp.id=?
AND um2.manager_user_id=?

");

$rbm_id = $_SESSION['user_id'];
mysqli_stmt_bind_param($stmtMaster,"ii",$id,$rbm_id);

mysqli_stmt_execute($stmtMaster);
$tour = mysqli_fetch_assoc(mysqli_stmt_get_result($stmtMaster));

// FIX: redirect if record not found or doesn't belong to this MR
if (!$tour) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
											...
											switch ($tour['status']) {
												...
												case 'Submitted':
													echo '<span class="badge bg-warning">Pending ABM Approval</span>';
													break;

												case 'ABM Approved':
													echo '<span class="badge bg-info">Pending RBM Approval</span>';
													break;

												case 'RBM Approved':
													echo '<span class="badge bg-primary">Pending Admin Approval</span>';
													break;
												...
												default:
													echo '<span class="badge bg-secondary">'.$tour['status'].'</span>';
													break;
											}
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
									...
									<?php if($tour['status']=='ABM Approved'){ ?>

<div class="mt-3">

    <a href="tour-plan-approve.php?id=<?= $tour['id']; ?>"
    ...
    <a href="tour-plan-reject.php?id=<?= $tour['id']; ?>"
