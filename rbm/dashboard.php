    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                $pendingTour   = pendingTourPlans($conn, 'RBM', $_SESSION['user_id']);
                $pendingDCR    = pendingDCR($conn, 'RBM', $_SESSION['user_id']);
                $todayDoctor   = todayDoctorCalls($conn, $_SESSION['user_id'], 'RBM');
                $todayChemist  = todayChemistCalls($conn, $_SESSION['user_id'], 'RBM');
                $todayStockist = todayStockistCalls($conn, $_SESSION['user_id'], 'RBM');
                $todayWorking  = todayWorkingMRs($conn, $_SESSION['user_id'], 'RBM');
                $monthlyDoctor = monthlyDoctorCalls($conn, $_SESSION['user_id'], 'RBM');
                $monthlyDCR    = monthlyDCR($conn, $_SESSION['user_id'], 'RBM');
                $monthlyTour   = monthlyTourPlans($conn, $_SESSION['user_id'], 'RBM');
                ?>
                <div class="row mb-4">
                        ...
                        <div class="card border-0 shadow rounded-4 h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <small class="text-muted">Pending Tour Approval</small>
                        ...
                        <div class="card border-0 shadow rounded-4 h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <small class="text-muted">Pending DCR Approval</small>
