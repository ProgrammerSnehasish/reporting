...
if (!empty($row['working_with_user_id']) && $row['working_with_user_id'] != '0') {
    ...
    $ww  = mysqli_query($conn, "
        SELECT CONCAT(e.first_name,' ',e.last_name) AS name, e.employee_code, r.role_name
        FROM tbl_users u
        INNER JOIN tbl_employees e ON e.id = u.employee_id
    ...
    while ($w = mysqli_fetch_assoc($ww)) {
        $names[] = $w['employee_code'] . ' - ' . $w['name'] . ' (' . strtoupper($w['role_name']) . ')';
    }
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 text-end d-flex gap-2 justify-content-end align-items-center">
                        <?php if ($row['status'] == 1) { ?>
                            <a href="dcr-approve.php?id=<?php echo $id; ?>"
                                class="btn btn-success btn-sm"
                                onclick="return confirm('Approve this DCR?')">
                                <i class="ri-check-line me-1"></i> Approve
                            </a>
                            <a href="dcr-reject.php?id=<?php echo $id; ?>"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="card-body p-0">
                                <table class="table table-sm table-borderless mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:13px;"><?php echo $row['employee_name']; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-muted ps-3" style="font-size:13px;">Day</td>
                                        <td style="font-size:13px;"><?php echo date('l', strtotime($row['visit_date'])); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-muted ps-3" style="font-size:13px;">Area</td>
                                    ...
                                    <tr>
                                        <td class="text-muted ps-3" style="font-size:13px;">Travel Exp</td>
                                        <td style="font-size:13px;">₹ <?php echo number_format($row['travel_expense'], 2); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:12px;"><?php echo $row['submission_ip']; ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <!-- GPS Info -->
                        <?php if (!empty($row['start_latitude'])) { ?>
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h6 class="mb-0"><i class="ri-map-pin-line me-1"></i> GPS Tracking</h6>
                                </div>
                                <div class="card-body">
                                    <p class="text-muted mb-1" style="font-size:12px;">Start Location</p>
                                    <p style="font-size:12px;" class="mb-2">
                                        <?php echo $row['start_latitude']; ?>, <?php echo $row['start_longitude']; ?>
                                        <a href="https://maps.google.com/?q=<?php echo $row['start_latitude']; ?>,<?php echo $row['start_longitude']; ?>"
                                            target="_blank" class="ms-1">
                                            <i class="ri-external-link-line"></i>
                                        </a>
                                    </p>
                                    <?php if (!empty($row['end_latitude'])) { ?>
                                        <p class="text-muted mb-1" style="font-size:12px;">End Location</p>
                                        <p style="font-size:12px;" class="mb-0">
                                            <?php echo $row['end_latitude']; ?>, <?php echo $row['end_longitude']; ?>
                                            <a href="https://maps.google.com/?q=<?php echo $row['end_latitude']; ?>,<?php echo $row['end_longitude']; ?>"
                                                target="_blank" class="ms-1">
                                                <i class="ri-external-link-line"></i>
                                            </a>
                                        </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p style="font-size:13px;" class="mb-0"><?php echo !empty($row['achievement']) ? nl2br(htmlspecialchars($row['achievement'])) : '-'; ?></p>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $sl++; ?></td>
                                                    <td>
                                                        <strong style="font-size:13px;"><?php echo htmlspecialchars($doctor['doctor_name']); ?></strong>
                                                        <br>
                                                        <small class="text-muted"><?php echo $doctor['doctor_code']; ?></small>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $sl++; ?></td>
                                                    <td>
                                                        <strong style="font-size:13px;"><?php echo htmlspecialchars($chemist['chemist_name']); ?></strong>
                                                        <br>
                                                        <small class="text-muted"><?php echo $chemist['chemist_code']; ?></small>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $sl++; ?></td>
                                                    <td>
                                                        <strong style="font-size:13px;"><?php echo htmlspecialchars($stockist['stockist_name']); ?></strong>
                                                        <br>
                                                        <small class="text-muted"><?php echo $stockist['stockist_code']; ?></small>
                                                    </td>
