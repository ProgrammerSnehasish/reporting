                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?= !empty($row['designation_name']) ? $row['designation_name'] : "-"; ?>

                                                </td>

                                                <td>

                                                    <?= !empty($row['designation_code']) ? $row['designation_code'] : "-"; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="employee-view.php?id=<?= $row['id']; ?>"
                                                    ...
                                                    <a href="user-add.php?employee_id=<?= $row['id']; ?>"
