                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title mb-0">Chemist Details</h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <a href="chemist-list.php" class="btn btn-secondary">
                                    Back
                                </a>

                                <a href="chemist-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">
                                    Edit
                                </a>
