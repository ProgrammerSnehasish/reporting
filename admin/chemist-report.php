...
if (!empty($chemist_id)) {
    $sql .= " AND cc.chemist_id = '$chemist_id' ";
}

$sql .= " ORDER BY dr.visit_date DESC, cc.visit_time DESC";
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Chemist Report</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Chemist Report</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    ...
                    <h4 class="card-title">Chemist Filter Report</h4>
